		...
		<div class="container_tw">
			<div class="tw_title">
				...
				<div class="tools-right">
					<el-button type="primary" class="tools-button" @click="addCompany">
			...
			<div class="tw_form">
				<el-table :data="companyList" style="width: 100%" class="table">
					<el-table-column prop="id" label="编号" width="180"></el-table-column>
					<el-table-column prop="companyName" label="名称" width="180"></el-table-column>
					<el-table-column prop="companyPhone" label="联系电话" width="180"></el-table-column>
...
<script>
	...
	import { getCompanyList,addPropertyCompany,getPropertyDetail,editPropertyCompany,getAllPropertyCompany } from '@/api/property'
...
//          { min: 3, max: 5, message: '长度在 3 到 5 个字符', trigger: 'blur' }
          ...
          companyPhone: [
            { required: true, message: '请输入物业公司电话', trigger: 'blur' },
          ],
          legalPerson: [
        ...
        this.$refs.form.validate(valid => {
		      if (valid) {
		      	...
		      	if(this.addOrEdit == "edit"){
		      		editPropertyCompany(this.form).then(response => {
				          if (response.code == '200') {
				          	this.$message({
						          message: '编辑成功',
						          type: 'success'
		      		...
		      		addPropertyCompany(this.form).then(response => {
				          if (response.code == '200') {
				          	this.$message({
						          message: '新增成功',
						          type: 'success'
