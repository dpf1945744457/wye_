	...
	<div class="login-container">
		<el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
          ...
          <svg-icon icon-class="user" />
				...
				<el-input ref="account" v-model="loginForm.account" placeholder="请输入用户名" name="username" type="text" tabindex="1" autocomplete="on" />
			</el-form-item>
			...
			<el-form-item prop="userType">
				<el-select ref="userType" v-model="loginForm.userType" placeholder="请选择用户类型" style="margin-bottom: 0;" @change="changeUserType">
