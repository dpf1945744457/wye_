<template>
  <div class="container">
    <div class="container_on">
      ...
      <div class="on_input" :style="{height: isShow?'120px':'80px'}">
        ...
        <el-row>
          ...
          <el-col :span="7" style="margin:0 20px">
            <div class="grid-content bg-purple">
        ...
        <!-- <div class="on_input" height="isShow ? '60px': '200px'" :style="{height: isShow?'80px':'120px'}"> -->
    ...
    <div class="container_tw">
      <div class="tw_on">
        <P>申请钥匙</P>
        <el-button size="mini" round class="tw_button " icon="el-icon-circle-plus">申请</el-button>
      </div>
      <div class="tw_form">
